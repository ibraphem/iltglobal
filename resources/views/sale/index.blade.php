                                ...
                                <div class="form-group">
                                   ...
                                   <select class="form-control select2" name="customer_id" required>
                                    ...
                                    <div class="col-sm-2 no-margin no-left-padding">
                                        <a class="btn btn-primary pull-right" href="{{url('expenses')}}/#modal-id" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp; {{__('Add')}}</a>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="payment_type" class="col-sm-4 control-label">{{trans('sale.payment_type')}}</label>
                                    <div class="col-sm-8">
                                    {{ Form::select(__('payment_type'), ['None' => __('None'),'Cash' => __('Cash'), 'check' => __('Cheque'), 'DebitCard' => __('Debit Card'), 'Transfer' => __('Transfer')], null, array('class' => 'form-control','placeholder'=>__('Select a payment type'),'required')) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary custom-item-btn">{{trans('item.submit')}}</button>
                                            </div>
                                            {{ Form::close() }}
                                        </div>
                                    </div>
